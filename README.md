...
Backend API and frontend are bundled in the same app for educational simplicity.

Note: this README documents backend API routes only. Frontend routes are intentionally not listed.
